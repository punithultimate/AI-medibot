...
def submit() :
    ...
    if chat == 'father' or chat == 'creator' or chat == 'developer' or chat == 'programmer':
          answer = "Punith Gowda v"
...
welcome_chatbot = Label (frame_welcome , text = 'I am AI Chatbot ! ' , font = "Helvetica 15 bold italic" , bg = c1 , fg = c6)
...
chatbot_name = Label (frame_info , text = 'Give AI Chatbot a Name : ' , bg = c1 , fg = c2 , font = 'Ariel 15')
...
select_label = Label (frame_topic , text = "what are you suffering from?" , bg = c1 , fg = "white" , font = 'Ariel 30 italic')
select_label.pack()

spacer5 = Label(frame_topic , bg = c1)
spacer5.pack()

option_1 = Label (frame_topic , text = '1- cold' , font = 'Verdana 15 italic' , bg = c1 , fg= c2)
...
option_2 = Label (frame_topic , text = '2- cough' , font = 'Verdana 15 italic' , bg = c1 , fg= c2)
...
option_3 = Label (frame_topic , text = '3-  stomach ache ' , font = 'Verdana 15 italic' ,bg = c1 , fg= c2)
...
option_4 = Label (frame_topic , text = '4- headache   ' , font = 'Verdana 15 italic' , bg = c1 , fg= c2)
...
option_5 = Label (frame_topic , text = '5-  fever ' , font = 'Verdana 15 italic' , bg = c1 , fg= c2)
